...
@section('header')
    <div class="d-flex justify-between">
        ...
        <div>
            <a href="{{ route('downloads.create') }}"><button class="btn btn-dark">Create</button></a>
        </div>
    </div>
@endsection
...
<script>
  $(document).ready(function() {
    ...
    $("body").on('click','.delete',function() {
            ...
            var deleteUrl = "{{ route('downloads.delete', ':id') }}".replace(':id', articleId);
