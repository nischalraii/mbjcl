...
@section('header')
    <div class="d-flex justify-between">
        ...
        {{-- <div>
            <a href="{{ route('users.create') }}"><button class="btn btn-dark">Create</button></a>
        </div> --}}
    </div>
@endsection
  ...
  $(document).ready(function() {
    ...
    $('#myTable').DataTable({
        ...
        columns: [
            ...
            { data: 'id', name: 'id' },
            { data: 'roles', name: 'roles' },  // Add this line
    ...
    $("body").on('click','.delete',function() {
            ...
            var deleteUrl = "{{ route('users.delete', ':id') }}".replace(':id', userId);
